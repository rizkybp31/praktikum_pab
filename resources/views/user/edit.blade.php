<x-app-layout>
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
      User &raquo; {{ $item->food_name }} &raquo; Edit
    </h2>
  </x-slot>
  <div class="py-12">
...
text-xs font-bold mb-2" for="grid-last-name">
              ...
              <input value="{{ old('food_name') ?? $item->food_name }}" name="food_name" class="appearance-none block w-full bg-gray-200 text-gray-700 border 

<x-app-layout>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="mb-10">
        <a href="{{ url('/food/create') }}" class="bg-green-500 hover:bggreen-700 text-white font-bold py-2 px-4 rounded">
          + Create Food
        </a>
      </div>
      <div class="bg-white">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="border px-6 py- text-center">
                <a href="{{ url('/food/edit', $item->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded">
                  Edit
                </a>
                <form action="{{ url('/food/destroy', $item->id) }}" method="POST" class="inline-block">
                  @csrf
